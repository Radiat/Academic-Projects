...
public class TilePuzzleDriver {
  ...
  public static int[][] getLayoutFromFile(String layoutFileName)
    ...
    int numOfColumns = 0;
    String temp = "";
    // It does an initial run through the file to determine dimensions.
    ...
    //At this part, we actually read the file and translate to an array.
  ...
  public static void main(String[] args) throws IOException {
    ...
    if (args.length < 2) {
      ...
      // This first part is for if there was no argument for the initial
      // directory. Although I do not know how this may be, this is to 
      // theoritically handle it.
      if (args[0].equals("")) {
      ...
      if (result == JFileChooser.APPROVE_OPTION) {
        ...
        //This part is to handle the file if it theoritically does not exist.
        if (puzzFile.exists()) {
