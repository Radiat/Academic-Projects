...
<xsl:param name="neighborhoodType"></xsl:param>
...
<!-- Start of HTML body -->
 ...
 <body>
   <table>
    <xsl:apply-templates select="unit[neighborhood=$neighborhoodType]">
...
<xsl:template match="unit">
    <xsl:variable name="tempLandlord" select="/rentor/landlord"/>
